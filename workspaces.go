...
func main() {
    ...
    if strings.Contains(flags, "S"){
        flags_sep_end = flags_sep_end + " " + b_green + " " + b_end
        flags_sep_start = b_green + " " + b_end + " " + flags_sep_start
    }
